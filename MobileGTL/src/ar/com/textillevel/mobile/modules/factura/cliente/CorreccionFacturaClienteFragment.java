...
public class CorreccionFacturaClienteFragment extends FragmentDocumentWithController<CorreccionFacturaMobTO, CorreccionFacturaClienteFragmentController> {

    public CorreccionFacturaClienteFragment(CorreccionFacturaMobTO correccionFactura) {
    	super(correccionFactura);
    	super.setController(new CorreccionFacturaClienteFragmentController(this));
    }

	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.factura_cliente_fragment, container, false);
        super.setDatosCabecera(new DatosCabeceraCorreccionFacturaClienteRenderer(getDocument(), rootView));
