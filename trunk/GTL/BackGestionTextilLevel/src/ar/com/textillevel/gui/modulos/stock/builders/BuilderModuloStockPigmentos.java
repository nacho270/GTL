...
public class BuilderModuloStockPigmentos implements IBuilderAccionAdicional<ItemMateriaPrimaTO>, 
	...
	private static BuilderModuloStockPigmentos instance = new BuilderModuloStockPigmentos();
	
	public static BuilderModuloStockPigmentos getInstance() {
		return instance;
	}
