...
public class BuilderModuloStockTelas implements IBuilderAccionAdicional<ItemMateriaPrimaTO>, 
	...
	private static BuilderModuloStockTelas instance = new BuilderModuloStockTelas();
	
	public static BuilderModuloStockTelas getInstance() {
		return instance;
	}
