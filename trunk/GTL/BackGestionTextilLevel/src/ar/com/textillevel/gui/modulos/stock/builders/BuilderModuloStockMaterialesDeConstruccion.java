...
public class BuilderModuloStockMaterialesDeConstruccion implements IBuilderAccionAdicional<ItemMateriaPrimaTO>, 
	...
	private static BuilderModuloStockMaterialesDeConstruccion instance = new BuilderModuloStockMaterialesDeConstruccion();
	
	public static BuilderModuloStockMaterialesDeConstruccion getInstance() {
		return instance;
	}
	...
	public Tabla<ItemMateriaPrimaTO> construirTabla(int idModel) {
		...
		tabla.addColumna(new ColumnaStockDescripcion("Material"));
