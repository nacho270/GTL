package ar.com.textillevel.gui.modulos.chat.notifications.notifier;
...
import ar.com.textillevel.gui.modulos.chat.notifications.cache.ColorCache;
import ar.com.textillevel.gui.modulos.chat.notifications.cache.FontCache;
...
public class NotifierDialog {
    ...
    public static void notify(String title, String message, NotificationType type) {
        ...
        text.setCursor(new Cursor(Display.getDefault(), SWT.CURSOR_HAND));
