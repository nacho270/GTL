       ...
       BEGIN
               ...
               loop_mp_rep: LOOP
                    ...
                    loop_internal: LOOP
		                 ...
		                 SET @ddlq2 = CONCAT ('UPDATE gtltest.',TABLA_DE_LA_B,' INNER JOIN ', TABLA_EQUIV_DE_LA_A, ' EQUIV ON ', COLUMNA_CONST_EN_LA_B, ' = EQUIV.P_ID SET ', COLUMNA_CONST_EN_LA_B, ' = EQUIV.P_ID_A;');
