       ...
       BEGIN
               ...
               loop_mp_rep: LOOP
                    ...
                    loop_internal: LOOP
		                 ...
		                 SET @ddlq2 = CONCAT('INSERT INTO T_DEBUG_MIG_CONSTRAINTS (A_TABLA_PADRE, A_TABLA_OWNER_CONST, A_COLUMNA_CONSTRAINT, A_CANT_REGISTROS) SELECT ''',TABLA_DE_LA_A,''',''', TABLA_DE_LA_B,''',''',COLUMNA_CONST_EN_LA_B, ''', COUNT(*) FROM gtltest.', TABLA_DE_LA_B, ' TH LEFT JOIN gtltest.',TABLA_DE_LA_A, ' TP ON TP.P_ID=TH.',COLUMNA_CONST_EN_LA_B, ' WHERE TP.P_ID IS NULL AND TH.',COLUMNA_CONST_EN_LA_B,' IS NOT NULL');
