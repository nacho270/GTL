...
public final class MultiButtonTable2 {
	private JComponent makeUI() {
		String[] columnNames = { "REPORT ID", "ACTION" };
		Object[][] data = { { "Report1", EnumSet.of(Actions.PRINT) }, { "Report2", EnumSet.of(Actions.PRINT, Actions.EDIT) }, { "Report3", EnumSet.allOf(Actions.class) }, { "Report4", EnumSet.of(Actions.PRINT) } };
	...
	public static void createAndShowGUI() {
		...
		f.getContentPane().add(new MultiButtonTable2().makeUI());
		f.setSize(320, 240);
