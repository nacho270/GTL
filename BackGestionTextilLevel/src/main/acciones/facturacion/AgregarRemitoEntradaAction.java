...
public class AgregarRemitoEntradaAction implements Action {
	
	private Frame frame;

	public AgregarRemitoEntradaAction(Frame frame) {
		this.frame = frame;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(clienteElegido != null) {
			...
			JDialogAgregarRemitoEntrada dialogAgregarRemitoEntrada = new JDialogAgregarRemitoEntrada(frame, remitoEntrada, new ArrayList<OrdenDeTrabajo>(), false);
