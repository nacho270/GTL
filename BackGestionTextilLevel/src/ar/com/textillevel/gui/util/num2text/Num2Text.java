package ar.com.textillevel.gui.util.num2text;
...
public class Num2Text {
	...
	public static void main(String[] args){
		...
		if(Math.floor(numero.doubleValue())-Math.abs(numero.doubleValue())==0){
			...
			System.out.println(Num2Text.getInstance().convertirLetras(Integer.parseInt(pe)) + " con " + Num2Text.getInstance().convertirLetras(Integer.parseInt(pd)));
		}
	}
}
