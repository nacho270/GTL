...
public class GuiAsignacionAlertasPerfil extends GuiABMListaTemplate {
	...
	private CLDobleLista listasAlertas;
	...
	private CLDobleLista getListasAlertas() {
		if(listasAlertas == null){
			listasAlertas = new CLDobleLista("Alertas disponibles", "Alertas agregadas",CLDobleLista.VERTICAL_LAYOUT);
