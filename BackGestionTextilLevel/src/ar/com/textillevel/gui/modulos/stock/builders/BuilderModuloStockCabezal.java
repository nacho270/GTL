...
import ar.com.textillevel.gui.modulos.stock.columnas.cabezales.ColumnaStockDiametroCabezal;
...
public class BuilderModuloStockCabezal implements IBuilderAccionAdicional<ItemMateriaPrimaTO>, 
	...
	private static BuilderModuloStockCabezal instance = new BuilderModuloStockCabezal();

	public static BuilderModuloStockCabezal getInstance() {
		return instance;
	}
	...
	public Tabla<ItemMateriaPrimaTO> construirTabla(int idModel) {
		...
		tabla.addColumna(new ColumnaStockDiametroCabezal());
