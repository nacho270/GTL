...
public class PanDatosMaquinaSectorEstamperia extends PanDatosMaquinaCommon {
	...
	private MaquinaSectorEstampado maquina;

	public PanDatosMaquinaSectorEstamperia() {
		super();
		construct();
	}
	...
	private void construct() {
		...
		add(createLabel(LABEL_VEL_MINIMA), GenericUtils.createGridBagConstraints(0, 2,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(10, 10, 5, 5), 1, 1, 0, 0));
		add(getTxtVelMin(), GenericUtils.createGridBagConstraints(1, 2, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 1, 1, 0, 0));
		add(createLabel(LABEL_VEL_MAXIMA), GenericUtils.createGridBagConstraints(2, 2,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(10, 10, 5, 5), 1, 1, 0, 0));
		add(getTxtVelMax(), GenericUtils.createGridBagConstraints(3, 2, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 1, 1, 0, 0));
		add(createLabel(LABEL_VEL_PROM), GenericUtils.createGridBagConstraints(4, 2,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 1, 1, 0, 0));
		add(getTxtVelProm(), GenericUtils.createGridBagConstraints(5, 2, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 5, 1, 0, 0));

		add(createLabel(LABEL_TEMP_MIN), GenericUtils.createGridBagConstraints(0, 3,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(10, 10, 5, 5), 1, 1, 0, 0));
		add(getTxtTempMin(), GenericUtils.createGridBagConstraints(1, 3, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(10, 10, 5, 5), 1, 1, 0, 0));
		add(createLabel(LABEL_TEMP_MAX), GenericUtils.createGridBagConstraints(2, 3,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(10, 10, 5, 5), 1, 1, 0, 0));
		add(getTxtTempMax(), GenericUtils.createGridBagConstraints(3, 3, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(10, 10, 5, 5), 1, 1, 0, 0));
		add(createLabel(LABEL_TEMP_MAX), GenericUtils.createGridBagConstraints(4, 3,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(10, 10, 5, 5), 1, 1, 0, 0));
		add(getTxtTempProm(), GenericUtils.createGridBagConstraints(5, 3, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(10, 10, 5, 5), 1, 1, 0, 0));

		add(createLabel(LABEL_CANT_CAMPOS), GenericUtils.createGridBagConstraints(0, 4,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(10, 10, 5, 5), 1, 1, 0, 0));
		add(getTxtCantCampos(), GenericUtils.createGridBagConstraints(1, 4, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(10, 10, 5, 5), 1, 1, 0, 0));
		add(createLabel(LABEL_CANT_COLORES), GenericUtils.createGridBagConstraints(2, 4,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(10, 10, 5, 5), 1, 1, 0, 0));
	...
	public void limpiarDatos() {
		super.limpiarDatos();
		getTxtCantColores().setText(null);
	...
	public void setMaquina(MaquinaSectorEstampado mse) {
		this.maquina = mse;
		...
		getTxtCantColores().setText(maquina.getCantColores() == null ? "" : maquina.getCantColores().toString());
	...
	public MaquinaSectorEstampado getMaquinaConDatosSeteados() {
		...
		maquina.setCantColores(getTxtCantColores().getValue());
	...
	public ValidadorCamposMaquinaHandler configureValidadorHandler() {
		...
		handler.addValidacion(new ValidacionCompletitud(this.getParent(), getTxtCantColores(), LABEL_CANT_COLORES));
		handler.addValidacion(new ValidacionMayorQueCero(this.getParent(), getTxtCantColores(), LABEL_CANT_COLORES));
