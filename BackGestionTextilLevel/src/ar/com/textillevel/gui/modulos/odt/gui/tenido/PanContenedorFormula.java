...
//		getPanMateriaPrima().limpiar();
	...
	public void setModoConsulta(boolean modoConsulta) {
		...
		getPanFormulas().getBtnVericar().setEnabled(!modoConsulta && getPanFormulas().getTabla().getSelectedRow() != -1);
		getPanFormulas().getBtnImprimir().setEnabled(getPanFormulas().getTabla().getSelectedRow() != -1);
	}
