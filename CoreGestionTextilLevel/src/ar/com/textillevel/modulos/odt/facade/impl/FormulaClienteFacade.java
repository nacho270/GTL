...
@Stateless
public class FormulaClienteFacade implements FormulaClienteFacadeRemote {

	@EJB
	private FormulaClienteDAOLocal formulaTenidoClienteDAO;
	...
	public FormulaCliente getById(Integer id) {
		return formulaTenidoClienteDAO.getById(id);
	}
}