...
public class FECompConsResponse  extends ar.com.textillevel.modulos.fe.cliente.requests.FECAEDetRequest  implements java.io.Serializable {
    ...
    private ar.com.textillevel.modulos.fe.cliente.dto.Obs[] observaciones;
     ...
     */
    public ar.com.textillevel.modulos.fe.cliente.dto.Obs[] getObservaciones() {
        return observaciones;
    }
     ...
     * @param observaciones
     */
    public void setObservaciones(ar.com.textillevel.modulos.fe.cliente.dto.Obs[] observaciones) {
        this.observaciones = observaciones;
    }
