...
@Entity
@Table(name="T_FP_ODP_PERSONA")
@Inheritance(strategy=InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name="TIPO",discriminatorType=DiscriminatorType.STRING)
@DiscriminatorValue(value="FP")
public abstract class FormaPagoOrdenDePagoPersona implements Serializable{

	private static final long serialVersionUID = 570365813154540453L;
