...
@Entity
@DiscriminatorValue("LAVA__ESP_TERMOF")
public class ProductoLavadoEspecialYTermofijado extends Producto implements Serializable{
	...
	public ETipoProducto getTipo() {
		return ETipoProducto.LAVADO_ESPECIAL_Y_TERMOFIJADO;
	}
}
