...
@Entity
@DiscriminatorValue("LAVA_TERMOF")
public class ProductoLavadoYTermofijado extends Producto implements Serializable{
	...
	public ETipoProducto getTipo() {
		return ETipoProducto.LAVADO_Y_TERMOFIJADO;
	}
}
